    ...
    <div class="install-section lang-content de active">
        ...
        <div id="verify-requirements" class="tab-content active">
            ...
            <div class="code-block" style="position: relative; padding-bottom: 45px;">
                ...
                <div id="copy-feedback-oneliner-de" class="copy-feedback" style="bottom: 50px; top: auto;">Kopiert! <span data-icon="checkmarkSimple" data-color="white" data-size="16"></span></div>
            </div>
    ...
    return `
        <div id="verify-requirements-en" class="tab-content active">
            ...
            <div class="code-block" style="position: relative; padding-bottom: 45px;">
                ...
                <div id="copy-feedback-oneliner-en" class="copy-feedback" style="bottom: 50px; top: auto;">Copied! <span data-icon="checkmarkSimple" data-color="white" data-size="16"></span></div>
            </div>
